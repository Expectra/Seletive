...
def nova_tarefa(request, id_vaga):
    ...
    try: 
        ...
        messages.add_message(request, constants.ERROR, 'Banco de dados fora do ar! Tente novamente em instântes...')
        return redirect(f'/vagas/vaga/{id_vaga}')
...
def envia_email(request, id_vaga):
    ...
    if email.send():
        ...
        mail.save()
        messages.add_message(request, constants.ERROR, 'Não conseguimos enviar o seu e-mail, por favor tente mais tarde!')
        return redirect(f'/vagas/vaga/{id_vaga}')
